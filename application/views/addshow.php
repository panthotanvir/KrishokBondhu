			...
			<li><a href="#">ভেষজ</a>
					...
					<li><a href="#">নয়নতারা </a></li>                    
                        ...
                        <td width="800px">
                         ...
                         <tr> 
                              <td>   <table>
                                    <tr><td>পণ্যের নাম</td><td><?php echo $row['product_name']; ?></td></tr>
                                    <tr><td>পণ্যের পরিমাণ(কেজি)</td><td><?php echo $row['product_amount']; ?></td></tr>
                                    <tr><td>বিজ্ঞাপনের তারিখ</td><td><?php echo $row['product_date']; ?></td></tr>
                                    <tr><td>মেয়াদউত্তীর্ণ তারিখ </td><td><?php echo $row['product_datelast']; ?></td></tr>
                                 </table> 
                              </td>
                              <td>   
                                <table>
                                    <tr><td>ক্রেতার নাম</td><td><?php echo $row['customer_name']; ?></td></tr>
                                    <tr><td>জাতীয় পরিচয়প্ত্র</td><td><?php echo $row['national_id']; ?></td></tr>
                                    <tr><td>লাইসেন্স নং</td><td><?php echo $row['license_id']; ?></td></tr>
                                    <tr><td>মোবাইল</td><td><?php echo $row['mobile_id']; ?></td></tr>
                                    <tr><td>বাজারের নাম</td><td><?php echo $row['bazarname']; ?></td></tr>
                                    <tr><td>থানা</td><td><?php echo $row['thana']; ?></td></tr>
                                    <tr><td>জেলা</td><td><?php echo $row['district']; ?></td></tr>
